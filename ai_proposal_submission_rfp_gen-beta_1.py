...
st.header('AI RFP "Proposal Submission" Section Generator')
st.subheader('current version : beta 0.1')

# Set the if, else loop including prompt
article_text = st.text_area('Please enter the text material(s) or URL you would like to generate the "Proposal Submission" section of an RFP from')
